                            ...
                            <div className='w-max mx-auto'>
                                <div className='mb-10'>
                                    <small className='block text-xl'>
                                        © 2020 <span className='textanimate'>xlincw0w</span>. All Rights Reserved
                                    </small>
                                </div>
                                <div className='text-center'>
                                    <a href='https://github.com/xlincw0w' target='_blank' className='inline-block mx-8 hover:text-red-400 cursor-pointer'>
                                        <AiOutlineGithub size={48} className='mx-auto' />
                                        <p>
                                            <span className='text-red-400'>Git</span>hub
                                        </p>
                                    </a>
                                    <a href='https://www.facebook.com/xlincw0w/' target='_blank' className='inline-block mx-8 hover:text-red-400 cursor-pointer'>
                                        <AiOutlineFacebook size={48} className='mx-auto' />
                                        <p>
                                            <span className='text-red-400'>Face</span>book
                                        </p>
                                    </a>
                                    <a href='https://www.instagram.com/xlincw0w/' target='_blank' className='inline-block mx-8 hover:text-red-400 cursor-pointer'>
